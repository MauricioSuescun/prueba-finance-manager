          ...
          {session?.user ? (
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <button
                ...
                className="bg-gray-800 hover:bg-gray-900 text-white px-6 py-2 rounded-lg font-semibold transition-colors flex items-center justify-center mx-auto gap-2"
              >
